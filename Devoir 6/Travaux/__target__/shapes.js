// Transcrypt'ed from Python, 2018-12-14 02:27:50
...
export var set_colors = function (Ka, Kd, Ks) {
	...
	gl.uniform4fv (gl.getUniformLocation (prog.prog, 'ambientProduct'), flatten (ambientProduct));
	gl.uniform4fv (gl.getUniformLocation (prog.prog, 'diffuseProduct'), flatten (diffuseProduct));
	gl.uniform4fv (gl.getUniformLocation (prog.prog, 'specularProduct'), flatten (specularProduct));
};
